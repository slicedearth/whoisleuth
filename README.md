...
| **Discover** | Generate bounded typo, Unicode-confusable, keyboard, separator, word-order, and impersonation candidates, with optional Certificate Transparency discovery. | Candidate generation is local. Certificate-log observations do not prove site activity or maliciousness. |
