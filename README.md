...
| **Discover** | Generate bounded typo, Unicode-confusable, keyboard, separator, word-order, and impersonation candidates, with optional Certificate Transparency discovery. Internationalised candidates show their Unicode and DNS-safe forms together. | Candidate generation is local. Confusability is a review lead, while certificate-log observations do not prove site activity or maliciousness. |
