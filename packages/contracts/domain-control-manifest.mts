...
export const DOMAIN_CONTROL_SCHEMA_LIFECYCLE = defineSchemaLifecycleFamily({
  ...
  metadata: {
    ...
    hooks: [
      ...
      { id: 'domain-control.browser.build-input', role: 'builder', runtime: 'browser', module: 'packages/workspace/domain-control-passport.mts', exportName: 'buildBrandProfilePassportInput' },
      { id: 'domain-control.browser.build-document', role: 'builder', runtime: 'browser', module: 'packages/workspace/domain-control-passport.mts', exportName: 'buildDomainControlPassport' },
      { id: 'domain-control.browser.verify-unexpired', role: 'integrity_verifier', runtime: 'browser', module: 'packages/workspace/domain-control-passport.mts', exportName: 'verifyDomainControlPassport' },
      { id: 'domain-control.browser.apply', role: 'merger', runtime: 'browser', module: 'packages/workspace/domain-control-passport.mts', exportName: 'applyVerifiedDomainControlPassport' },
