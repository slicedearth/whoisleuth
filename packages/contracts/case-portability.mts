...
export const CASE_DOMAIN_COMPATIBILITY_FACADES = Object.freeze([
  ...
  ['frontend/src/lib/analysis/case-type-evidence-readiness.ts', 'packages/cases/case-type-evidence-readiness.mts'],
...
const CASE_LIFECYCLE_FIXTURES = Object.freeze([
  ...
  Object.freeze({
    id: 'browser-case-v15',
    path: 'test/fixtures/case-lifecycle/browser-case-v15.json',
    bytes: 2221,
  ...
  Object.freeze({
    id: 'case-export-v15',
    path: 'test/fixtures/case-lifecycle/case-export-v15.json',
    bytes: 3211,
  ...
  Object.freeze({
    id: 'case-report-v11',
    path: 'test/fixtures/case-lifecycle/case-report-v11.json',
    bytes: 4640,
  ...
  Object.freeze({
    ...
    bytes: 4640,
    sha256: 'e170f1822490a02101bbe04de5c2e355bea3720c6c4bfc368b41b47084bccb57',
    contentDigestSha256: null,
    schema: CASE_REPORT_SCHEMA,
  ...
  Object.freeze({
    id: 'case-response-packet-v9',
    path: 'test/fixtures/case-lifecycle/case-response-packet-v9.json',
    bytes: 12275,
  ...
  Object.freeze({
    id: 'case-response-review-inputs-v3',
    path: 'test/fixtures/case-lifecycle/case-response-review-inputs-v3.json',
    bytes: 7604,
  ...
  Object.freeze({
    ...
    bytes: 9363,
    sha256: 'e25e98602c92e696a50c9fd48924c6c13853a5c23ea6fe617abc0b89d8c9e8ee',
    contentDigestSha256: 'sha256:50044835b0e7aa45137b2f75b9894aa35c71101c769062eb524078bfb55eecc0',
    schema: CLI_CASE_PACK_SCHEMA,
    version: CLI_CASE_PACK_VERSION,
    role: 'current' as const,
    expectation: 'accepted_exact' as const,
  ...
  Object.freeze({
    id: 'cli-case-pack-v2-case-v15',
    path: 'test/fixtures/case-lifecycle/cli-case-pack-v2-case-v15.json',
    bytes: 9439,
    sha256: '9c07b7828f5e348a6e9ca05e1bd487998851491d85d0b30b38adba196f84faee',
    contentDigestSha256: 'sha256:475a91fe7c3afddd3f73ba5b9a698c08bc7b37f3fb67bcf86441ee908beb0dc8',
    schema: CLI_CASE_PACK_SCHEMA,
    version: CLI_CASE_PACK_VERSION,
    role: 'current' as const,
    expectation: 'accepted_exact' as const,
  ...
  Object.freeze({
    ...
    bytes: 9439,
    sha256: '303fbe1fe11ed308d0cb956c5c628dc2fb197d54341cb7b06732fb4ae9376643',
    contentDigestSha256: 'sha256:bf41184b4d130caffa534e943cc0893026c34d255e39fa8558dba6ddae85594c',
    schema: CLI_CASE_PACK_SCHEMA,
    version: CLI_CASE_PACK_VERSION,
    role: 'current' as const,
    expectation: 'accepted_exact' as const,
  ...
  Object.freeze({
    id: 'workspace-archive-v8-empty-current',
    path: 'test/fixtures/case-lifecycle/workspace-archive-v8-empty-current.json',
    bytes: 7258,
