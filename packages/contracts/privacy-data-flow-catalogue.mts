...
const CAPABILITY_PRIVACY_DETAILS = Object.freeze({
  ...
  analyst_cases: capabilityPrivacyDetail('Retain analyst-selected Case material, recheck question context and separately selected original files using the current workspace codec; Review Item lifecycle state remains separately bounded.', ['bounded_case_state', 'recheck_question_context', 'selected_original_files_and_provenance', 'bounded_analyst_review_state']),
