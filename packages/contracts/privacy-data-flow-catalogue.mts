...
const CAPABILITY_PRIVACY_DETAILS = Object.freeze({
  ...
  portable_evidence: capabilityPrivacyDetail('Build, verify or review bounded portable ZIP or folder evidence under operator control; folder handles are not retained for background access.', ['bounded_portable_evidence', 'integrity_or_compatibility_state']),
