...
export const SUPPORTED_ACQUISITION_DECISION_PACKET_VERSIONS = Object.freeze([1, ACQUISITION_DECISION_PACKET_VERSION] as const);
...
export const SUPPORTED_BULK_DOMAIN_COMPARISON_EXPORT_VERSIONS = Object.freeze([3, BULK_DOMAIN_COMPARISON_EXPORT_VERSION] as const);
...
export const SUPPORTED_BULK_MAIL_EXPOSURE_EXPORT_VERSIONS = Object.freeze([1, BULK_MAIL_EXPOSURE_EXPORT_VERSION] as const);
...
export const SUPPORTED_BULK_REVIEW_MANIFEST_VERSIONS = Object.freeze([1, BULK_REVIEW_MANIFEST_VERSION] as const);
...
export const INVESTIGATION_CAPSULE_COMPATIBILITY = defineSchemaCompatibility({
  ...
  acceptsUnversionedLegacy: false, futureVersionBehavior: 'reject', migration: 'read_only', writeSemantics: 'read_only',
  byteBudget: MAX_INVESTIGATION_PORTABLE_BYTES, owner: INVESTIGATION_PORTABILITY_CONTRACT_OWNER,
  note: 'Version 3 embeds investigation brief v2 with canonical Decision Facts; versions 2 and 3 retain whole-capsule sorted-json-v2 integrity, while version 1 remains verifiable only for its embedded projections.',
});
...
export const LOOKUP_INVESTIGATION_BRIEF_COMPATIBILITY = defineSchemaCompatibility({
  ...
  note: 'Version 2 replaces legacy summary and decision-entry arrays with one bounded canonical Decision Fact projection; version 1 remains structurally verified when embedded in supported capsule versions.',
});
...
const INVESTIGATION_FIXTURES = Object.freeze([
  { id: 'acquisition-decision-v1', path: 'test/fixtures/investigation-portability/acquisition-decision-v1.json', bytes: 6_236, sha256: 'aa3824f0c27dc8aacb04b2c9ad3900756642e20ab2ec3d7a5083e87483742abf', schema: ACQUISITION_DECISION_PACKET_SCHEMA, version: 1, role: 'historical' as const },
  ...
  { id: 'bulk-domain-comparison-v3', path: 'test/fixtures/investigation-portability/bulk-domain-comparison-v3.json', bytes: 17_037, sha256: 'b1cd593583b4e796131f4d4d074dd70dea73c51b9a65adafd9384c61ab876c23', schema: BULK_DOMAIN_COMPARISON_SCHEMA, version: 3, role: 'historical' as const },
  ...
  { id: 'bulk-mail-exposure-v1', path: 'test/fixtures/investigation-portability/bulk-mail-exposure-v1.json', bytes: 2_540, sha256: '5738cc71f760ff9a213c25f7e680421e9ffab521826549a1cad18e2a754390f0', schema: BULK_MAIL_EXPOSURE_SCHEMA, version: 1, role: 'historical' as const },
  ...
  { id: 'bulk-review-manifest-v1', path: 'test/fixtures/investigation-portability/bulk-review-manifest-v1.json', bytes: 1_615, sha256: '460d01619d78c8a7c9c7cc5bae936d8fb500b27ebf7e9d2c640bde279107ff8e', schema: BULK_REVIEW_MANIFEST_SCHEMA, version: 1, role: 'historical' as const },
  ...
  { id: 'investigation-capsule-v1', path: 'test/fixtures/investigation-portability/investigation-capsule-v1.json', bytes: 4_845, sha256: 'de468afa26a18d6560d10ce507f087ee171cd49966f727c87ff256e81a72ffa4', schema: INVESTIGATION_CAPSULE_SCHEMA, version: 1, role: 'historical' as const },
...
const INVESTIGATION_CONTRACTS = Object.freeze([
  ...
  ...SUPPORTED_BULK_DOMAIN_COMPARISON_EXPORT_VERSIONS.map((version) => investigationContract({ compatibilityId: BULK_DOMAIN_COMPARISON_COMPATIBILITY.id, schema: BULK_DOMAIN_COMPARISON_SCHEMA, version, currentVersion: BULK_DOMAIN_COMPARISON_EXPORT_VERSION, canonicalisation: version === 3 ? 'sorted-json-v1' : 'sorted-json-v2', byteBudget: MAX_INVESTIGATION_PORTABLE_BYTES })),
  ...SUPPORTED_BULK_MAIL_EXPOSURE_EXPORT_VERSIONS.map((version) => investigationContract({ compatibilityId: BULK_MAIL_EXPOSURE_COMPATIBILITY.id, schema: BULK_MAIL_EXPOSURE_SCHEMA, version, currentVersion: BULK_MAIL_EXPOSURE_EXPORT_VERSION, canonicalisation: version === 1 ? 'sorted-json-v1' : 'sorted-json-v2', byteBudget: MAX_INVESTIGATION_PORTABLE_BYTES })),
  ...SUPPORTED_BULK_REVIEW_MANIFEST_VERSIONS.map((version) => investigationContract({ compatibilityId: BULK_REVIEW_MANIFEST_COMPATIBILITY.id, schema: BULK_REVIEW_MANIFEST_SCHEMA, version, currentVersion: BULK_REVIEW_MANIFEST_VERSION, canonicalisation: version === 1 ? 'sorted-json-v1' : 'sorted-json-v2', byteBudget: MAX_INVESTIGATION_PORTABLE_BYTES })),
  ...SUPPORTED_INVESTIGATION_CAPSULE_VERSIONS.map((version) => investigationContract({ compatibilityId: INVESTIGATION_CAPSULE_COMPATIBILITY.id, schema: INVESTIGATION_CAPSULE_SCHEMA, version, currentVersion: INVESTIGATION_CAPSULE_VERSION, canonicalisation: version === 1 ? 'embedded-projection-digests-v1' : 'sorted-json-v2', byteBudget: MAX_INVESTIGATION_PORTABLE_BYTES })),
...
const INVESTIGATION_SHAPES = Object.freeze([
  investigationShape('investigation.acquisition.v1-v2', ACQUISITION_DECISION_PACKET_SCHEMA, [...SUPPORTED_ACQUISITION_DECISION_PACKET_VERSIONS], ['schema', 'version', 'generatedAt', 'target', 'synthetic', 'evidenceObservedAt', 'analystReview', 'evidenceReview', 'limitations', 'integrity'], 'preserve_signed_document'),
  ...
  investigationShape('investigation.domain-comparison.v3-v4', BULK_DOMAIN_COMPARISON_SCHEMA, [...SUPPORTED_BULK_DOMAIN_COMPARISON_EXPORT_VERSIONS], ['schema', 'version', 'generatedAt', 'comparison', 'integrity'], 'preserve_signed_document'),
  investigationShape('investigation.mail-exposure.v1-v2', BULK_MAIL_EXPOSURE_SCHEMA, [...SUPPORTED_BULK_MAIL_EXPOSURE_EXPORT_VERSIONS], ['schema', 'version', 'report', 'integrity'], 'preserve_signed_document'),
  investigationShape('investigation.bulk-review.v1-v2', BULK_REVIEW_MANIFEST_SCHEMA, [...SUPPORTED_BULK_REVIEW_MANIFEST_VERSIONS], ['schema', 'version', 'generatedAt', 'observedAt', 'lookupProfile', 'selection', 'view', 'rows', 'limitations', 'integrity'], 'preserve_signed_document'),
  investigationShape('investigation.capsule.v1-v3', INVESTIGATION_CAPSULE_SCHEMA, [...SUPPORTED_INVESTIGATION_CAPSULE_VERSIONS], ['schema', 'schemaVersion', 'generatedAt', 'application', 'target', 'sourceContracts', 'investigationBrief', 'graphSnapshot', 'analystRecords', 'limitations', 'integrity'], 'preserve_signed_document'),
...
export const INVESTIGATION_PORTABILITY_LIFECYCLE_FAMILY = defineSchemaLifecycleFamily({
  ...
  metadata: {
    ...
    serialisationProfiles: [{
      id: 'investigation.capsule.json.v1-v3',
    ...
    consumerEdges: [
      {
        ...
        shapeIds: ['investigation.acquisition.v1-v2', 'investigation.claim-passport.v1', 'investigation.domain-comparison.v3-v4', 'investigation.mail-exposure.v1-v2', 'investigation.bulk-review.v1-v2', 'investigation.capsule.v1-v3'],
      ...
      },
      {
        ...
        shapeIds: ['investigation.asset-graph.v2', 'investigation.analyst-records.v1', 'investigation.brief.v1', 'investigation.brief.v2', 'investigation.capsule.v1-v3'],
        ...
        serialisationProfileId: 'investigation.capsule.json.v1-v3',
        privacyProfileId: 'investigation.privacy.output', retentionEffect: 'operator_controlled_output', ...investigationConsumerCommon,
      },
      ...([
        ['investigation.consumer.acquisition-build', ACQUISITION_DECISION_PACKET_SCHEMA, ACQUISITION_DECISION_PACKET_VERSION, 'investigation.acquisition.v1-v2', 'investigation.acquisition.build', 'investigation.portable.bounds'],
        ...
        ['investigation.consumer.domain-comparison-build', BULK_DOMAIN_COMPARISON_SCHEMA, BULK_DOMAIN_COMPARISON_EXPORT_VERSION, 'investigation.domain-comparison.v3-v4', 'investigation.domain-comparison.build', 'investigation.portable.bounds'],
        ['investigation.consumer.mail-exposure-build', BULK_MAIL_EXPOSURE_SCHEMA, BULK_MAIL_EXPOSURE_EXPORT_VERSION, 'investigation.mail-exposure.v1-v2', 'investigation.mail-exposure.build', 'investigation.portable.bounds'],
        ['investigation.consumer.bulk-review-build', BULK_REVIEW_MANIFEST_SCHEMA, BULK_REVIEW_MANIFEST_VERSION, 'investigation.bulk-review.v1-v2', 'investigation.bulk-review.build', 'investigation.portable.bounds'],
