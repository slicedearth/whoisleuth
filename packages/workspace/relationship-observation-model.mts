...
import {
  ...
  MAX_RELATIONSHIP_OBSERVATION_DOMAINS,
  MAX_RELATIONSHIP_OBSERVATION_INPUTS,
  MAX_RELATIONSHIP_OBSERVATION_LIMITATIONS,
  MAX_RELATIONSHIP_OBSERVATION_STORE_BYTES,
  MAX_RELATIONSHIP_OBSERVATION_VALUE_LENGTH,
...
function record(value: unknown): UnknownRecord | null {
  return ordinaryWorkspaceRecord(value, 'Relationship-observation input');
}
