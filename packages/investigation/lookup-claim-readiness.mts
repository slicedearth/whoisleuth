import type { EvidenceCoverageLedger, EvidenceCoverageState } from './evidence-coverage-ledger.mts';
import type { LookupDecisionSupport, LookupTaskView } from './lookup-artefact-inputs.mts';
import { LOOKUP_CLAIM_READINESS_VERSION } from '../contracts/investigation-portability.mts';

export type LookupClaimReadinessState = 'ready' | 'limited' | 'not_ready';
export { LOOKUP_CLAIM_READINESS_VERSION };
