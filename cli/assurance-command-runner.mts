...
const ASSURANCE_COMMAND_HANDLERS = Object.freeze({
  'manifest': runManifestCommand,
  'map-observations': runObservationBridgeCommand,
  'oam-export': runObservationBridgeCommand,
  'domain-control': runDomainControlCommand,
  'assurance': runAssuranceReviewCommand,
  'change-packet': runChangePacketCommand,
  'sharing-review': runSharingReviewCommand,
...
export { ASSURANCE_COMMAND_HANDLERS, runAssuranceCommand };
