...
const SUPPORT_COMMAND_HANDLERS = Object.freeze({
  'completion': runCompletionCommand,
  'commands': runCommandCatalogueCommand,
  'manual': runManualCommand,
  'doctor': runDoctorCommand,
  'registry-support': runRegistrySupportCommand,
  'registry-doctor': runRegistryDoctorCommand,
  'registry-cohort': runRegistryCohortCommand,
  'registry-scaffold': runRegistryScaffoldCommand,
  'risk-calibrate': runRiskCalibrationCommand,
...
export { SUPPORT_COMMAND_HANDLERS, runSupportCommand };
