...
const { buildLookupEvidenceReport, cleanReportText } = require('./evidence-report');

function escapeHtml(value, fallback = 'Not reported') {
...
function formatLookupEvidenceHtml(document) {
...
module.exports = { escapeHtml, formatLookupEvidenceHtml };
