...
const ENTRIES: SchemaCompatibilityEntry[] = [
  ...
  entry({ id: 'export.cases', kind: 'export', schema: null, currentVersion: CASE_SCHEMA_VERSION, supportedVersions: [3, 4, 5, 6, 7, 8, 9, 10, 11], acceptsUnversionedLegacy: false, futureVersionBehavior: 'reject', migration: 'normalize_to_current', writeSemantics: 'non_destructive_merge', byteBudget: MAX_CASE_IMPORT_BYTES, owner: 'frontend/src/lib/analysis/case-model.ts', note: 'Non-destructive merge accepts supported case schemas and rejects older or future versions; version 11 adds reference-only named investigation branches.' }),
