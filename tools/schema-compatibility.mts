...
const ENTRIES: SchemaCompatibilityEntry[] = [
  ...
  entry({ id: 'export.lookup-evidence', kind: 'export', schema: LOOKUP_EVIDENCE_SCHEMA, currentVersion: LOOKUP_EVIDENCE_SCHEMA_VERSION, supportedVersions: [25, 26], acceptsUnversionedLegacy: false, futureVersionBehavior: 'reject', migration: 'read_only', writeSemantics: 'read_only', byteBudget: LOOKUP_EVIDENCE_PORTABLE_MAX_BYTES, owner: 'lib/evidence-export.mts', note: 'Bounded normalised lookup package. Version 26 binds projected diagnostics and publication-bearing source data to explicit source states and shares all portable browser/CLI limits; version 25 remains readable with retained diagnostics authoritative over historical wrapper mismatches.' }),
  ...
  entry({ id: 'cli.mail-transport-input', kind: 'cli_document', schema: MAIL_TRANSPORT_INPUT_SCHEMA, currentVersion: MAIL_TRANSPORT_REVIEW_VERSION, supportedVersions: [1], acceptsUnversionedLegacy: false, futureVersionBehavior: 'reject', migration: 'exact_current_only', writeSemantics: 'read_only', byteBudget: MAX_MAIL_TRANSPORT_INPUT_BYTES, owner: 'lib/smtp-transport-review.mts', note: 'Bounded analyst-selected MX and supplied policy-context input; it cannot select more than three endpoints.' }),
  ...
  entry({ id: 'cli.mail-transport-review', kind: 'cli_document', schema: MAIL_TRANSPORT_REVIEW_SCHEMA, currentVersion: MAIL_TRANSPORT_REVIEW_VERSION, supportedVersions: [1], acceptsUnversionedLegacy: false, futureVersionBehavior: 'not_applicable', migration: 'read_only', writeSemantics: 'read_only', byteBudget: null, owner: 'lib/smtp-transport-review.mts', note: 'Isolated authorised SMTP, STARTTLS, PKIX, DNSSEC and DANE review retaining normalised evidence and exact relationship leads only.' }),
