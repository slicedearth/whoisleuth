...
const ENTRIES: SchemaCompatibilityEntry[] = [
  ...
  entry({ id: 'browser.website-snapshots', kind: 'browser_store', schema: WEBSITE_SNAPSHOT_SCHEMA, currentVersion: WEBSITE_SNAPSHOT_SCHEMA_VERSION, supportedVersions: [1, 2, 3], acceptsUnversionedLegacy: true, futureVersionBehavior: 'preserve_without_write', migration: 'normalize_to_current', writeSemantics: 'normalized_rewrite', byteBudget: MAX_WEBSITE_SNAPSHOT_STORE_BYTES, owner: 'frontend/src/lib/analysis/website-snapshot-model.ts', note: 'Only explicit analyst-selected compact website profiles and optional normalized leaf-certificate observations are retained; raw lookup payloads, contact data, certificate bytes, and fetched bodies remain excluded.' }),
