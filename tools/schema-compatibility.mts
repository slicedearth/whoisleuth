...
const ENTRIES: SchemaCompatibilityEntry[] = [
  ...
  entry({ id: 'maintainer.evidence-storage-measurement-fixture', kind: 'cli_document', schema: EVIDENCE_STORAGE_MEASUREMENT_FIXTURE_SCHEMA, currentVersion: EVIDENCE_STORAGE_MEASUREMENT_VERSION, supportedVersions: [1], acceptsUnversionedLegacy: false, futureVersionBehavior: 'reject', migration: 'exact_current_only', writeSemantics: 'read_only', byteBudget: MAX_MEASUREMENT_FIXTURE_BYTES, owner: 'tools/evidence-storage-measurement.mts', note: 'Bounded reserved synthetic corpus and reviewed thresholds for the local evidence-storage architecture decision.' }),
  entry({ id: 'maintainer.evidence-storage-measurement', kind: 'cli_document', schema: EVIDENCE_STORAGE_MEASUREMENT_SCHEMA, currentVersion: EVIDENCE_STORAGE_MEASUREMENT_VERSION, supportedVersions: [1], acceptsUnversionedLegacy: false, futureVersionBehavior: 'not_applicable', migration: 'read_only', writeSemantics: 'read_only', byteBudget: null, owner: 'tools/evidence-storage-measurement.mts', note: 'Deterministic target-free storage, duplication, candidate-overhead, and compatibility-footprint measurement.' }),
