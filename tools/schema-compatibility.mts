...
const ENTRIES: SchemaCompatibilityEntry[] = [
  ...
  entry({ id: 'tab.candidate-handoff', kind: 'tab_store', schema: null, currentVersion: HANDOFF_VERSION, supportedVersions: [1], acceptsUnversionedLegacy: false, futureVersionBehavior: 'discard', migration: 'exact_current_only', writeSemantics: 'ephemeral_replace', byteBudget: MAX_CANDIDATE_HANDOFF_SERIALIZED_BYTES, owner: 'frontend/src/lib/candidate-handoff-core.ts', note: 'Bounded session handoff; unsupported envelopes are ignored.' }),
