...
const ENTRIES: SchemaCompatibilityEntry[] = [
  ...
  entry({ id: 'cli.investigation-manifest', kind: 'cli_document', schema: INVESTIGATION_MANIFEST_SCHEMA, currentVersion: INVESTIGATION_MANIFEST_VERSION, supportedVersions: [INVESTIGATION_MANIFEST_VERSION], acceptsUnversionedLegacy: false, futureVersionBehavior: 'reject', migration: 'exact_current_only', writeSemantics: 'read_only', byteBudget: MAX_INVESTIGATION_MANIFEST_TOTAL_BYTES, owner: 'cli/investigation-manifest.mts', note: 'The v1.47.4 current writer uses deterministic sorted-json-v2 root and canonical-content digests in a path-free ordered manifest; it does not prove evidence truth.' }),
