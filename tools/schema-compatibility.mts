...
const ENTRIES: SchemaCompatibilityEntry[] = [
  ...
  entry({ id: 'cli.domain-change-packet', kind: 'cli_document', schema: DOMAIN_CHANGE_PACKET_SCHEMA, currentVersion: DOMAIN_CHANGE_PACKET_VERSION, supportedVersions: [DOMAIN_CHANGE_PACKET_VERSION], acceptsUnversionedLegacy: false, futureVersionBehavior: 'reject', migration: 'exact_current_only', writeSemantics: 'read_only', byteBudget: null, owner: 'lib/domain-change-packet.mts', note: 'The v1.47.4 current writer uses deterministic sorted-json-v2 integrity for the local change packet; the digest does not establish the truth of its observations.' }),
