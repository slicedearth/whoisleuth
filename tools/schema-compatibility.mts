...
export const MAX_SCHEMA_COMPATIBILITY_ENTRIES = 150;
...
const ENTRIES: SchemaCompatibilityEntry[] = [
  ...
  entry({ id: 'browser.ct-history', kind: 'browser_store', schema: null, currentVersion: CT_HISTORY_SCHEMA_VERSION, supportedVersions: [1, 2], acceptsUnversionedLegacy: false, futureVersionBehavior: 'preserve_without_write', migration: 'normalize_to_current', writeSemantics: 'normalized_rewrite', byteBudget: MAX_CT_HISTORY_STORE_BYTES, owner: 'frontend/src/lib/analysis/ct-history.ts', note: 'Version 2 adds bounded per-query discarded-check provenance; version 1 migrates with pruning certainty explicitly unknown, malformed values degrade to an empty bounded history, and future stores are not overwritten.' }),
  ...
  entry({ id: 'export.acquisition-decision', kind: 'export', schema: ACQUISITION_DECISION_PACKET_SCHEMA, currentVersion: ACQUISITION_DECISION_PACKET_VERSION, supportedVersions: [1], acceptsUnversionedLegacy: false, futureVersionBehavior: 'reject', migration: 'exact_current_only', writeSemantics: 'read_only', byteBudget: MAX_OFFLINE_ARTIFACT_BYTES, owner: 'frontend/src/lib/analysis/acquisition-decision-packet.ts', note: 'Integrity-protected bounded acquisition review. It records analyst decisions and manual checks without making an availability, eligibility, ownership, valuation, or purchase determination.' }),
  entry({ id: 'export.domain-comparison', kind: 'export', schema: BULK_DOMAIN_COMPARISON_SCHEMA, currentVersion: BULK_DOMAIN_COMPARISON_VERSION, supportedVersions: [3], acceptsUnversionedLegacy: false, futureVersionBehavior: 'reject', migration: 'exact_current_only', writeSemantics: 'read_only', byteBudget: MAX_OFFLINE_ARTIFACT_BYTES, owner: 'frontend/src/lib/analysis/bulk-domain-comparison.ts', note: 'Integrity-protected comparison of bounded retained evidence with source-only, conflicting, missing, and unavailable states preserved separately.' }),
  entry({ id: 'export.bulk-mail-exposure', kind: 'export', schema: BULK_MAIL_EXPOSURE_SCHEMA, currentVersion: BULK_MAIL_EXPOSURE_VERSION, supportedVersions: [1], acceptsUnversionedLegacy: false, futureVersionBehavior: 'reject', migration: 'exact_current_only', writeSemantics: 'read_only', byteBudget: MAX_OFFLINE_ARTIFACT_BYTES, owner: 'frontend/src/lib/analysis/bulk-mail-exposure.ts', note: 'Integrity-protected bounded mail-posture review using retained source states. Missing or incomplete DNS evidence remains inconclusive.' }),
  entry({ id: 'export.bulk-review-manifest', kind: 'export', schema: BULK_REVIEW_MANIFEST_SCHEMA, currentVersion: BULK_REVIEW_MANIFEST_VERSION, supportedVersions: [1], acceptsUnversionedLegacy: false, futureVersionBehavior: 'reject', migration: 'exact_current_only', writeSemantics: 'read_only', byteBudget: MAX_OFFLINE_ARTIFACT_BYTES, owner: 'frontend/src/lib/analysis/bulk-review-export.ts', note: 'Integrity-protected manifest for one bounded Bulk review selection and view; raw payloads, contacts, notes, and transient request state are excluded.' }),
  entry({ id: 'export.investigation-capsule', kind: 'export', schema: INVESTIGATION_CAPSULE_SCHEMA, currentVersion: INVESTIGATION_CAPSULE_VERSION, supportedVersions: [1], acceptsUnversionedLegacy: false, futureVersionBehavior: 'reject', migration: 'exact_current_only', writeSemantics: 'read_only', byteBudget: MAX_OFFLINE_ARTIFACT_BYTES, owner: 'frontend/src/lib/analysis/investigation-capsule.ts', note: 'Bounded investigation projections with projection-scoped digests. Capsule metadata and linked non-embedded evidence are not covered by those digests.' }),
  ...
  entry({ id: 'cli.offline-artifact-verification', kind: 'cli_document', schema: OFFLINE_ARTIFACT_VERIFICATION_SCHEMA, currentVersion: OFFLINE_ARTIFACT_VERIFICATION_VERSION, supportedVersions: [2], acceptsUnversionedLegacy: false, futureVersionBehavior: 'not_applicable', migration: 'read_only', writeSemantics: 'read_only', byteBudget: MAX_OFFLINE_ARTIFACT_BYTES, owner: 'cli/artifact-verify.mts', note: 'Version 2 separates structure, whole-file integrity, projection integrity, and encrypted-envelope assurance; verification remains distinct from evidence truth and full browser importability.' }),
  ...
  entry({ id: 'export.cli-case-pack', kind: 'export', schema: CLI_CASE_PACK_SCHEMA, currentVersion: CLI_CASE_PACK_VERSION, supportedVersions: [1], acceptsUnversionedLegacy: false, futureVersionBehavior: 'not_applicable', migration: 'read_only', writeSemantics: 'read_only', byteBudget: MAX_CASE_PACK_INPUT_BYTES, owner: 'cli/case-pack.mts', note: 'Audience-specific reviewed case package with canonical integrity; public Case v12 packs clear Brand Profile references and disclose brandProfileReferencesOmitted while trusted and internal packs preserve them.' }),
  ...
  entry({ id: 'cli.http', kind: 'cli_document', schema: CLI_HTTP_SCHEMA, currentVersion: CLI_HTTP_SCHEMA_VERSION, supportedVersions: [1, 2], acceptsUnversionedLegacy: false, futureVersionBehavior: 'not_applicable', migration: 'read_only', writeSemantics: 'read_only', byteBudget: null, owner: 'cli/formatters/json.mts', note: 'Bounded HTTP evidence output; version 2 separates an inconclusive activity assessment from a negative reachability claim while retaining the legacy field as nullable.' }),
