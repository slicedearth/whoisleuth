...
// their reviewed 344-module and 346-module closures.
...
export const MAX_CLI_RUNTIME_MODULES = 344;
export const MAX_CLI_PACKAGE_MODULES = 346;
...
// Keep the reviewed 345-entry closure exact; packed and unpacked byte ceilings
// remain independent controls.
export const MAX_CLI_PACKAGE_ENTRIES = 345;
