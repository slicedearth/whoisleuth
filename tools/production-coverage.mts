...
export const PRODUCTION_COVERAGE_EXCLUSIONS: readonly CoverageExclusion[] = Object.freeze([
  ...
  Object.freeze({ source: 'frontend/src/lib/bulk-sessions.ts', category: 'browser_adapter', owner: 'e2e/bulk-analysis.spec.ts' }),
  ...
  Object.freeze({ source: 'frontend/src/lib/controllers/lookup-anchor-controller.ts', category: 'browser_adapter', owner: 'e2e/design-system.spec.ts' }),
