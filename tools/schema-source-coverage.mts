...
const SCHEMA_INLINE_EMITTER_ALLOWLIST = Object.freeze([
  ...
  ['whoisleuth.shortlist', 'frontend/src/lib/browser-local-data-definitions.ts', [302, 307]],
  ['whoisleuth.sslbl-certificate-snapshot', 'lib/sslbl-certificates.generated.mts', [5]],
  ['whoisleuth.watchlists', 'frontend/src/lib/browser-local-data-definitions.ts', [288]],
] as const);
...
const SCHEMA_DYNAMIC_USE_ALLOWLIST = Object.freeze([
  ...
  ['frontend/src/lib/analysis/workspace-archive.ts', 637, 'reader', 'Compares a bounded archive entry marker to its reviewed section definition.'],
  ['frontend/src/lib/browser-local-data-definitions.ts', 208, 'reader', 'Compares a bounded store record marker with its reviewed store definition.'],
  ['frontend/src/lib/analysis/case-response-model.ts', 335, 'writer', 'Copies bounded source-provenance fields after local normalisation.'],
  ['frontend/src/lib/analysis/external-findings-converters.ts', 126, 'reader', 'Checks an input marker supplied by a reviewed observation-row adapter.'],
  ['frontend/src/lib/analysis/workspace-archive.ts', 563, 'writer', 'Copies a bounded archive-section marker after local normalisation.'],
  ['frontend/src/lib/analysis/workspace-archive.ts', 627, 'reader', 'Compares two bounded archive-section markers during import.'],
...
const SCHEMA_OWNER_USE_ALLOWLIST = Object.freeze([
  ...
  ['export.web-capture-manifest', 'frontend/src/lib/analysis/web-capture-import.ts', 'reader', [217]],
  ['export.web-capture-summary', 'frontend/src/lib/analysis/web-capture-import.ts', 'reader', [115]],
] as const);
