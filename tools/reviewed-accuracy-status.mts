...
const CORPORA: readonly Readonly<{
  ...
  Object.freeze({
    ...
    nextStep: 'Review minimized positive and benign-collision examples with a documented redistribution basis.',
  }),
  Object.freeze({
    key: 'page-similarity',
    ...
    nextStep: 'Retain only minimized component observations and reviewed component-level expectations.',
  }),
  Object.freeze({
    ...
    nextStep: 'Use the existing technology review tool to add minimized, licensed observations.',
  }),
  Object.freeze({
    ...
    nextStep: 'Review minimized active, unresolved, deprovision-cue, and benign provider responses.',
  }),
  Object.freeze({
    ...
    nextStep: 'Review minimized co-occurrence, wildcard, renewal, and unrelated-certificate examples.',
  }),
]);
