...
const KNOWN_CODEQL_FINDINGS: readonly KnownCodeqlFinding[] = Object.freeze([
  ...
  Object.freeze({ ruleId: 'js/incomplete-url-substring-sanitization', file: 'test/case-report.test.mts', primaryLocationLineHash: '1beaf56a554ac9e4:1', primaryLocationStartColumnFingerprint: '13', reason: 'used_in_tests' as const }),
  Object.freeze({ ruleId: 'js/incomplete-url-substring-sanitization', file: 'test/case-report.test.mts', primaryLocationLineHash: '49fe07e43d4a51e4:1', primaryLocationStartColumnFingerprint: '10', reason: 'used_in_tests' as const }),
  Object.freeze({ ruleId: 'js/incomplete-url-substring-sanitization', file: 'test/ct-search.test.mts', primaryLocationLineHash: '87440f158d857689:1', primaryLocationStartColumnFingerprint: '10', reason: 'used_in_tests' as const }),
  Object.freeze({ ruleId: 'js/incomplete-url-substring-sanitization', file: 'test/ct-search.test.mts', primaryLocationLineHash: 'e1adbaf9d2d01b06:1', primaryLocationStartColumnFingerprint: '10', reason: 'used_in_tests' as const }),
  Object.freeze({ ruleId: 'js/incomplete-url-substring-sanitization', file: 'test/ct-search.test.mts', primaryLocationLineHash: '63133cb78baecb59:1', primaryLocationStartColumnFingerprint: '10', reason: 'used_in_tests' as const }),
  Object.freeze({ ruleId: 'js/incomplete-url-substring-sanitization', file: 'test/ct-search.test.mts', primaryLocationLineHash: 'f8a646c95a35d1c8:1', primaryLocationStartColumnFingerprint: '11', reason: 'used_in_tests' as const }),
  Object.freeze({ ruleId: 'js/incomplete-url-substring-sanitization', file: 'test/ct-search.test.mts', primaryLocationLineHash: '6456a8f043208483:1', primaryLocationStartColumnFingerprint: '10', reason: 'used_in_tests' as const }),
  Object.freeze({ ruleId: 'js/incomplete-url-substring-sanitization', file: 'test/ct-search.test.mts', primaryLocationLineHash: '71a5d98ca5aaf83a:1', primaryLocationStartColumnFingerprint: '69', reason: 'used_in_tests' as const }),
  Object.freeze({ ruleId: 'js/incomplete-url-substring-sanitization', file: 'test/ct-search.test.mts', primaryLocationLineHash: '5c4c60322ce69230:1', primaryLocationStartColumnFingerprint: '10', reason: 'used_in_tests' as const }),
