...
const positiveFixtures: TechnologySignatureFixture[] = [
  ...
  positive('craft-cms', { generator: 'Craft CMS 5' }),
  ...
  positive('opencart', { generator: 'OpenCart 4' }),
  positive('prestashop', { generator: 'PrestaShop 9' }),
  ...
  positive('weebly', { generator: 'Weebly' }),
