export const INVESTIGATION_GUIDE_KEY = 'whoisleuth:investigation-guide:v4';
export const PREVIOUS_INVESTIGATION_GUIDE_KEY = 'whoisleuth:investigation-guide:v3';
export const LEGACY_INVESTIGATION_GUIDE_KEY = 'whoisleuth:investigation-guide:v2';
export const ORIGINAL_INVESTIGATION_GUIDE_KEY = 'whoisleuth:investigation-guide:v1';
