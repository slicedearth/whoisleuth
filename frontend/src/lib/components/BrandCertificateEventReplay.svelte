...
<style>
  .certificate-replay{display:grid;gap:18px;margin-top:16px;padding:var(--card-pad)}.section-head,.domain-review>header{display:flex;align-items:flex-start;justify-content:space-between;gap:16px}.section-head p,.domain-review p{margin:4px 0 0;color:var(--muted);max-width:72ch}.count,.state{white-space:nowrap;border:1px solid var(--border);border-radius:999px;padding:4px 8px;font-size:var(--text-xs);color:var(--muted)}.domain-list,.event-list{display:grid;gap:12px}.domain-review{min-width:0;border:1px solid var(--border);border-radius:var(--radius-md);padding:14px}.domain-review h3{margin:0;font-size:var(--text-md)}details{border:1px solid var(--border);border-radius:var(--radius-sm);background:var(--panel-raised)}summary{display:flex;align-items:center;justify-content:space-between;gap:12px;cursor:pointer;padding:12px;list-style:none}summary::-webkit-details-marker{display:none}summary::before{content:'›';color:var(--accent);font-size:1.2rem;line-height:1;transition:transform .15s ease}details[open] summary::before{transform:rotate(90deg)}.event-summary{display:grid;gap:3px;min-width:0;margin-right:auto}.event-summary small{color:var(--muted);overflow-wrap:anywhere}.state.aligned{border-color:color-mix(in srgb,var(--success) 45%,var(--border));color:var(--success)}.state.review{border-color:var(--amber);border-style:dashed;color:var(--amber)}.state.indeterminate{border-color:var(--amber);border-style:dashed;color:var(--amber)}.event-detail{display:grid;gap:12px;padding:0 12px 12px}dl,.clauses{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin:0}dl div,.clause,.names{min-width:0;border:1px solid var(--border);border-radius:var(--radius-sm);padding:10px}dt,.names strong,.case-links strong{font-size:var(--text-xs);text-transform:uppercase;letter-spacing:.06em;color:var(--muted)}dd{margin:4px 0 0;overflow-wrap:anywhere}.clause{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:4px}.clause p{grid-column:1/-1;font-size:var(--text-sm)}.names p{overflow-wrap:anywhere}.case-links{display:flex;flex-wrap:wrap;align-items:center;gap:8px}.case-links a{font-size:var(--text-sm)}ul{margin:0;padding-left:20px;color:var(--muted);font-size:var(--text-sm)}.notice{color:var(--amber)}.empty{font-size:var(--text-sm)}
