...
<style>
  ...
  .source-state,.scope{padding:11px 12px;border:1px solid var(--border);border-radius:var(--radius-sm);background:var(--panel-raised);font-size:var(--text-sm);line-height:1.5}.source-state{color:var(--muted)}.source-state.unavailable{color:var(--amber);border-color:rgb(var(--amber-rgb) / .45)}
