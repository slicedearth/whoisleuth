...
<style>
  ...
  @media(max-width:560px){header,.report-controls{display:grid}.metric-grid,.exact-grid,.duration-grid{grid-template-columns:1fr}header button,.report-controls select{width:100%}}
</style>
