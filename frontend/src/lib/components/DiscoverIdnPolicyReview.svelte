...
{#if unicodeCandidates.length}
  <details class="idn-policy card">
    ...
    <div class="controls">
      <label>Registry suffix<input bind:value={suffix} maxlength="253" placeholder="test" aria-label="Registry table suffix"></label>
      <label class="file">LGR XML file<input type="file" accept=".xml,application/xml,text/xml" onchange={selectFile}></label>
