  ...
  {#if review.events.length}
    <ol class="sequence">
      {#each review.events as event}
        <li class={`layer-${event.layer}`} data-layer={event.layer}>
...
<style>
  ...
  .coverage article{display:grid;min-width:0;gap:3px;padding:9px;border:1px solid var(--border);border-left:3px solid var(--layer-stroke,var(--border-strong));border-radius:var(--radius-sm);background:var(--panel-raised)}
  ...
  .marker{z-index:1;width:11px;height:11px;margin-top:4px;border:2px solid var(--panel);border-radius:50%;background:var(--layer-stroke,var(--muted))}
  .layer-registration{--layer-text:var(--visual-registration-text);--layer-stroke:var(--visual-registration-stroke)}
  .layer-ct,.layer-tls{--layer-text:var(--visual-certificate-text);--layer-stroke:var(--visual-certificate-stroke)}
  .layer-dns{--layer-text:var(--visual-dns-text);--layer-stroke:var(--visual-dns-stroke)}
  .layer-web{--layer-text:var(--visual-web-text);--layer-stroke:var(--visual-web-stroke)}
  .layer-mail{--layer-text:var(--visual-mail-text);--layer-stroke:var(--visual-mail-stroke)}
  .event-head{display:flex;flex-wrap:wrap;justify-content:space-between;gap:5px 10px}.event-head strong{overflow-wrap:anywhere;font-size:var(--text-xs)}.event-head span{color:var(--layer-text,var(--muted));font:650 var(--text-2xs) var(--mono)}
