...
<style>
  .relationship-graph{min-width:0;padding:18px;margin-bottom:18px}.relationship-graph h2,.inspector h3,.empty h3{margin:0}.relationship-graph>header p:not(.eyebrow),.help,.inspector p:not(.eyebrow),.inspector small,.empty p,details p{color:var(--muted);font-size:var(--text-xs);line-height:1.5}.relationship-graph>header p:not(.eyebrow){margin:6px 0 0}.partial{color:var(--amber);font:600 var(--text-2xs) var(--mono);text-transform:uppercase;letter-spacing:.05em}.graph-controls{display:flex;align-items:end;justify-content:space-between;gap:12px;margin:14px 0 8px}.graph-controls span{color:var(--muted);font-size:var(--text-xs)}.help{margin:14px 0 8px}.graph-scroll{max-width:100%;overflow:auto;border:1px solid var(--border);border-radius:var(--radius-md);background:linear-gradient(180deg,var(--panel),var(--panel-raised))}svg{display:block;width:100%;min-width:680px;height:auto;max-height:620px}.edges line{stroke:color-mix(in srgb,var(--muted) 32%,transparent);stroke-width:1.5}.edges line.active{stroke:var(--accent);stroke-width:3}.node{cursor:pointer;outline:none}.node rect{fill:var(--panel-raised);stroke:var(--border);stroke-width:1.5}.relationship-node rect{fill:color-mix(in srgb,var(--accent) 8%,var(--panel-raised));stroke:color-mix(in srgb,var(--accent) 50%,var(--border))}.node text{fill:var(--text);font-family:var(--mono);font-size:13px;pointer-events:none}.node:hover rect,.node:focus-visible rect,.node.selected rect{stroke:var(--accent);stroke-width:3}.inspector{min-width:0;padding:14px;margin-top:12px;border:1px solid var(--border);border-radius:var(--radius-md);background:var(--panel)}.inspector h3{font-size:var(--text-md);overflow-wrap:anywhere}.inspector code,.inspector small{display:block;margin-top:6px;overflow-wrap:anywhere}.inspector code{color:var(--accent);font-size:var(--text-xs);font-family:var(--mono)}.pivots{display:flex;flex-wrap:wrap;gap:6px;margin-top:10px}.pivots .btn,.inspector li .btn{overflow-wrap:anywhere}.open-case{margin-top:10px}.inspector ul{display:grid;gap:6px;padding:0;margin:10px 0 0;list-style:none}.inspector li .btn{width:100%;justify-content:flex-start;text-align:left}.empty{display:grid;min-height:220px;place-content:center;text-align:center}details{margin-top:13px}details summary{color:var(--muted);cursor:pointer;font-size:var(--text-xs)}
  @media(max-width:700px){.relationship-graph{padding:14px}.relationship-graph>header,.graph-controls{align-items:stretch;flex-direction:column}.graph-controls select{width:100%}.graph-scroll{overscroll-behavior-x:contain}.pivots{display:grid}.pivots .btn{width:100%}}
</style>
