...
<style>
  ...
  .timeline{margin-top:4px}.timeline-header{display:flex;flex-wrap:wrap;justify-content:space-between;gap:10px;align-items:center;margin-bottom:10px}.timeline-header h3{margin:0;font:700 var(--text-sm) var(--mono)}.timeline-header small{margin-left:8px;color:var(--muted);font-size:var(--text-2xs);font-weight:400}.timeline-controls{display:flex;flex-wrap:wrap;gap:7px}.timeline-controls button,.timeline-toggle{min-height:32px;padding:0 10px;border:1px solid var(--border);border-radius:var(--radius-sm);background:var(--panel-raised);font:600 var(--text-2xs) var(--mono)}.timeline-controls button[aria-pressed="true"]{color:var(--accent2);border-color:rgba(126,224,168,.55);background:rgba(126,224,168,.07)}.timeline-empty,.timeline-filter-note,.timeline-incomparable-note{color:var(--muted);font-size:var(--text-xs)}.timeline-empty{padding:12px;border:1px solid var(--border);border-radius:var(--radius-sm);background:var(--panel)}
