...
<section class="relationship-workspace" aria-labelledby="case-relationship-table-title">
  ...
  <fieldset class="relationship-filters card">
    ...
    <button type="button" aria-label={direction==='asc'?'Ascending, switch to descending':'Descending, switch to ascending'} onclick={()=>direction=direction==='asc'?'desc':'asc'}>{direction==='asc'?'Ascending':'Descending'}</button>
