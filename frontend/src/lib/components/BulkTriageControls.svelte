...
<section class="selection-actions" aria-labelledby="selection-actions-title">
  <div><strong id="selection-actions-title">{selectedCount} selected in the filtered set</strong><span>Selection is explicit and browser-local. Actions never include unselected rows.</span></div>
  <div class="action-row">
    <button class="btn" onclick={selectFiltered} disabled={!matchedCount}>Select filtered</button>
