...
export const guideFaqs: readonly GuideFaq[] = Object.freeze([
  ...
  Object.freeze({ question: 'Why are Deep results collapsed?', answer: 'Every detail mode initially collapses evidence families so a Deep result does not become one uninterrupted page. Evidence and All evidence make broader material available; open the families you need or use Expand all. A section link opens its destination. Nested RDAP, WHOIS, DNS, HTTP, page, certificate, and network records can remain collapsed. Summaries and source states stay visible. Layout changes never alter collection, scoring, exports, or saved evidence.' }),
