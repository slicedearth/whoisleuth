...
export const guideFaqs: readonly GuideFaq[] = Object.freeze([
  Object.freeze({ question: 'Can WHOISleuth identify a website platform or hosting provider?', answer: 'Deep Lookup can show curated technology indicators and the registered network for one observed public address. Proxies and shared infrastructure can obscure the origin host.' }),
  ...
  Object.freeze({ question: 'How do guided investigations work?', answer: 'Dashboard offers fixed guides and offline examples. A guide records progress and approved steps; you still start each collection, response or control action.' }),
  ...
  Object.freeze({ question: 'What does an SSLBL certificate result mean?', answer: 'Deep Lookup can compare an observed leaf-certificate fingerprint with a local warning-data snapshot. A match is a lead tied to that certificate observation; a miss does not establish safety.' }),
  ...
  Object.freeze({ question: 'Why are Deep results collapsed?', answer: 'Evidence families stay collapsed to keep long results readable. Summaries and source states remain visible, and Expand all opens every family.' }),
  Object.freeze({ question: 'Can I compare how a website changes over time?', answer: 'Yes. Save compact website snapshots from completed Deep Lookups and compare them later. Snapshots retain curated indicators, source health and optional normalised certificate evidence rather than raw page or registration payloads.' }),
  Object.freeze({ question: 'Can I save a relationship found in Bulk?', answer: 'Yes. Retain observation saves the normalised value, member domains, method, time, completeness and limitations in this browser. Review or delete it under Monitor Relationships.' }),
  ...
  Object.freeze({ question: 'What is sent to optional intelligence providers?', answer: 'Only enabled integrations run, and each declares the target representation it receives. External evidence pivots are ordinary links and open only when selected.' }),
