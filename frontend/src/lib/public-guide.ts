...
export const guideFaqs: readonly GuideFaq[] = Object.freeze([
  ...
  Object.freeze({ question: 'Should I use Fast or Deep lookup?', answer: 'Lookup defaults to Deep when a target merits richer registration, DNS, website, certificate and network context. Deep adds SOA and HTTPS service-binding context, compares separately attributed registry, recursive and direct nameserver evidence, and checks whether bounded A, AAAA, CAA and MX answers agree across selected authorities. Direct DNS failures remain inconclusive. Select Fast for registration-first triage. Bulk and the CLI retain explicit Fast and Deep controls.' }),
