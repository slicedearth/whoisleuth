...
export const toolGuides: readonly GuideEntry[] = Object.freeze([
  ...
  Object.freeze({ id: 'monitor', name: 'Monitor', useWhen: 'You want to retain a finding, document a decision, prepare a reviewed response or compare later observations.', input: 'Save a case or watchlist from Lookup or Bulk, retain selected Lookup facts, save a website profile snapshot or Bulk session, or retain one reviewed relationship observation.', result: 'The review inbox ranks unfinished work. Browser-local timelines project saved evidence without copying raw values. Retained change review derives rows for adjacent case or website snapshots, retained watchlist changes, and one explicitly selected Bulk pair. It shows mode, source state, time, completeness and limitations before values. Missing or partial evidence is not removal. Website pivots group technology and page-identity matches; campaign and cluster counts are not scores or attribution.', next: 'Use the inbox to continue unfinished work or filter the timeline. Choose one retained comparison, or explicitly pair two saved Bulk sessions, before opening exact rows and their owner. Review common software before relying on a website-pivot match. A stale record is a review cue, not a current finding. Review evidence and contact provenance before creating a local response packet; WHOISleuth does not submit it.' }),
]);
