...
export const toolGuides: readonly GuideEntry[] = Object.freeze([
  Object.freeze({ id: 'lookup', name: 'Lookup', useWhen: 'You have one domain, IP address or ASN to investigate.', input: 'Enter one target and choose Fast or Deep. Deep is the default; Ctrl+Enter or Command+Enter runs the same validated submission as the button. Optional security.txt and external intelligence sources run only when selected.', result: 'At a glance leads into task-ordered Registration, Web and DNS, Relationships and history, Source quality, Case and response, and Advanced evidence families. Essentials starts compact; Evidence and All evidence reveal broader detail. Every family can still be opened or collapsed independently. The source, relationship, and timeline views organise attributed evidence without changing its status or meaning. Partial and unavailable sources stay explicit. Reports cover domains, IPs and ASNs.', next: 'Choose Focus for the decision, then open only the evidence families needed. Review conflicting, partial, unavailable and time-sensitive evidence before retaining a fact. A completed Deep result can create a compact website-profile snapshot, and DNS-health evidence can support a local change rehearsal. Acquisition and change packets remain review checklists rather than proof of eligibility, ownership, price, transfer, or propagation. Check external pivot destinations before opening them.' }),
  Object.freeze({ id: 'brands', name: 'Brands', useWhen: 'You want searches and comparisons to reflect an official brand, or you want to review an owned domain defensively.', input: 'Add official domains, product names, preferred domain endings, trusted infrastructure, known active or retired DKIM selectors, an optional defensive mail profile, and reviewed control-planning context.', result: 'A browser-local profile provides a comparison boundary, bounded public posture audit, external-dependency inventory, separately stored expiring analyst attestations, and a Domain Control Centre for zone intent, lifecycle, recovery dependencies, approved change windows, and portfolio concentration.', next: 'Review the official-domain posture and control-planning gaps, or open Discover to generate related candidates.' }),
  ...
  Object.freeze({ id: 'monitor', name: 'Monitor', useWhen: 'You want to retain a finding, document a decision, prepare a reviewed response or compare later observations.', input: 'Save a case or watchlist from Lookup or Bulk, retain selected Lookup facts, save a website profile snapshot or Bulk session, or retain one reviewed relationship observation.', result: 'Browser-local timelines project retained Lookup snapshots, Bulk sessions, watchlist checks, case evidence, pins and relationships without copying raw values. Website pivots can group exact curated technology and page-identity matches from the latest saved profile per domain. Campaign and cluster counts are not scores or attribution findings. Observation and storage times stay separate, events link to their owners, and analyst reasoning remains distinct from observed evidence.', next: 'Filter the timeline by area, freshness, entity, case, source, evidence or change, and time; then open the owning record for exact values and limitations. Search website pivots by domain or evidence type and review common software or templates before treating a match as useful. A stale record is a review cue, not a current finding. Review evidence and contact provenance before creating a local response packet. WHOISleuth does not submit the packet.' }),
]);
...
export const guideFaqs: readonly GuideFaq[] = Object.freeze([
  ...
  Object.freeze({ question: 'Why are some Deep results collapsed?', answer: 'Essentials keeps evidence families compact so a Deep result does not become one uninterrupted page. Choose Evidence or All evidence for broader detail, or open and collapse each family independently. Nested RDAP, WHOIS, DNS, HTTP, page, certificate, and network records may also remain collapsed until needed. Source states and bounded summaries stay visible, and changing the layout never changes collection, scoring, exports, or saved evidence.' }),
