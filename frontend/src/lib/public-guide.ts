...
export const toolGuides: readonly GuideEntry[] = Object.freeze([
  ...
  Object.freeze({ id: 'bulk', name: 'Bulk', useWhen: 'You need to compare several candidate domains consistently.', input: 'Paste domains or accept a shortlist from Discover. One job accepts up to 500 Fast or 50 Deep targets. Choose Gentle, Balanced, or Standard request pacing. Bulk Deep uses compact WHOIS, DNS, website, TLS, and mail evidence rather than the complete single-domain response.', result: 'Fast or Deep checks prioritise candidates and show observed relationships. Bounded maps, profile-listed summaries, and an exact two-domain table describe retained evidence. Profile inclusion does not establish protection, ownership, or control. Live counts separate incomplete evidence from failure. The review cockpit supports disposition, shortlist, watchlist, and Lookup handoffs. Comparisons preserve source state, time, and conflicts. Saved sessions can be compared, exported, or resumed.', next: 'Select only the rows you intend to act on, then export, rescan, create cases, set existing case states, or save that selection to Monitor. Open the strongest or most uncertain leads in Lookup, and retain a useful relationship only after reviewing its limitations.' }),
