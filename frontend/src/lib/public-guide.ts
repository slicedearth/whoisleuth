...
export const glossaryTerms: readonly GuideDefinition[] = Object.freeze([
  ...
  Object.freeze({ term: 'Website profile snapshot', definition: 'An analyst-saved compact record of curated technology, posture, identity-digest, source-health, completeness and, when available, normalized observed leaf-certificate evidence from a completed Deep Lookup. A difference or shared fingerprint is a review lead, not proof of compromise or common control.' }),
