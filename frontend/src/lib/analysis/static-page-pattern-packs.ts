    ...
    rules: [
      {
        ...
        name: 'Reviewed pattern: wallet connection prompt',
        enabled: true,
        match: 'all',
        conditions: [{ field: 'phishingLanguageMatch', operator: 'contains', value: 'wallet' }],
        riskDelta: 0,
        tag: 'review-wallet-prompt',
      },
      {
        id: 'pack-wallet-seed-v1',
        name: 'Reviewed pattern: seed phrase prompt',
        enabled: true,
        match: 'all',
        conditions: [{ field: 'phishingLanguageMatch', operator: 'contains', value: 'seed phrase' }],
        riskDelta: 0,
        tag: 'review-wallet-prompt',
      },
      {
        id: 'pack-wallet-recovery-v1',
        name: 'Reviewed pattern: recovery phrase prompt',
        enabled: true,
        match: 'all',
        conditions: [{ field: 'phishingLanguageMatch', operator: 'contains', value: 'recovery phrase' }],
        riskDelta: 0,
        tag: 'review-wallet-prompt',
      },
      {
        id: 'pack-wallet-key-v1',
        name: 'Reviewed pattern: private key prompt',
        enabled: true,
        match: 'all',
        conditions: [{ field: 'phishingLanguageMatch', operator: 'contains', value: 'private key' }],
        riskDelta: 0,
        tag: 'review-wallet-prompt',
      },
    ],
