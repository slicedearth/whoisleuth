...
export const SYNTHETIC_DEMO_PROFILE = deepFreeze(syntheticProfile);
  ...
  return {
    ...
    dns: {
      ...
      rows: [
        ...
        ...(conclusive ? [{ label: 'HTTPS service binding', value: 'Service priority 1 → owner · ALPN h2, h3 · port 443 · fixture only' }] : []),
    ...
    technology: {
      ...
      libraryStatus: conclusive ? 'Success' : 'Partial',
      libraryComplete: conclusive,
      libraryCatalog: 'Synthetic catalogue fixture',
      libraries: active ? [
        {
          id: 'synthetic-example-library',
          name: 'Example UI Library',
          version: '1.2.3',
          detection: 'Script filename',
          advisoryCount: 1,
          severity: 'medium',
      ...
      libraryLimitations: ['Fixed synthetic component and advisory context for presentation only; it does not describe a live library or vulnerability.'],
    },
    network: {
