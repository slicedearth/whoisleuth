    ...
    facts: [
      {
        ...
        provenance: factProvenance({
          ...
          normalization: 'Authority-aware registration evidence is normalized into a stable availability state while inconclusive sources remain unknown.',
          limitations,
      ...
      },
      {
        ...
        provenance: factProvenance({
          ...
          normalization: 'Recognized lifecycle dates are parsed into an ISO-compatible instant when possible; the original source publication remains authoritative.',
          limitations,
      ...
      },
      {
        ...
        provenance: factProvenance({
          ...
          normalization: 'Recognized expiry dates are parsed into an ISO-compatible instant when possible without predicting deletion or release.',
          limitations,
      ...
      },
      {
        ...
        provenance: factProvenance({
          ...
          normalization: 'Recognized update dates are parsed into an ISO-compatible instant when possible and remain a source-reported lifecycle observation.',
          limitations,
