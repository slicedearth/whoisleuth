...
<div class="policy-layout">
  ...
  <article class="policy card" aria-labelledby="privacy-title">
    ...
    <p>For a URL pasted into Lookup, the browser sends only its full hostname for collection, without the port, path, query or fragment. Credential-bearing URLs are rejected. Deliberately retaining an exact Incident URL in a Case is a separate action.</p>
