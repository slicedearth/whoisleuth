...
<article class="resource-page">
  ...
  <section id="steps" aria-labelledby="steps-title">
    <div class="section-intro"><h2 id="steps-title">Suggested steps</h2></div>
    <ol class="steps">
  ...
  <aside class="repository card" id="technical-reference" aria-labelledby="technical-reference-title">
    ...
    <div><p>The repository documentation covers collection bounds, provenance, storage and exports.</p><a href={`${WHOISLEUTH_SOURCE_REPOSITORY_URL}/blob/main/${resource.repositoryDoc}`} target="_blank" rel="noopener">Open {resource.repositoryDoc}<span class="sr-only"> (opens in a new tab)</span></a></div>
  </aside>
</article>
</PublicReferenceDocument>

<style>
  .resource-page{display:grid;gap:0}.resource-page>section{padding:36px 0;border-top:1px solid var(--border)}.resource-page>section:first-child{padding-top:22px}.section-intro{max-width:780px;margin-bottom:25px}.section-intro h2,.repository h2{margin:.3rem 0 .65rem;font:700 clamp(1.45rem,3vw,2rem) var(--mono);letter-spacing:-.04em}
