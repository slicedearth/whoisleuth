...
<style>
  ...
  .principle{display:grid;grid-template-columns:.8fr 1.2fr;gap:40px;margin-top:28px;padding:clamp(22px,4vw,36px);border-left:3px solid var(--accent)}.principle h3{margin:.25rem 0 0;font:700 clamp(1.35rem,2.5vw,2rem) var(--mono);letter-spacing:-.04em}.principle>p{margin:0;color:var(--muted);line-height:1.65}
