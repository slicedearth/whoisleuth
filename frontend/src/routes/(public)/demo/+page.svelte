...
<style>
  ...
  .demo-steps{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:1px;margin:30px 0 12px;padding:5px}.demo-steps button{min-height:42px;border:0;border-radius:var(--radius-sm);background:transparent;color:var(--muted);font-size:var(--text-xs)}.demo-steps button.active{background:rgba(126,224,168,.1);color:var(--accent2)}
