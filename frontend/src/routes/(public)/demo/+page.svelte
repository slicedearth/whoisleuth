...
<details class="mobile-stage-guidance card">
  <summary><span class="mobile-stage-guidance-headings"><strong>Stage guidance</strong><span>Why it matters</span></span></summary>
...
<style>
  ...
  @media(max-width:760px){
    ...
    .stage-guidance{display:none}.mobile-stage-guidance{--guidance-label-column:104px;display:block;margin-bottom:8px;padding:0}.mobile-stage-guidance summary{position:relative;display:block;min-height:44px;padding:8px 30px 8px 11px;color:var(--text);cursor:pointer;list-style:none}.mobile-stage-guidance summary::-webkit-details-marker{display:none}.mobile-stage-guidance summary::after{content:"⌄";position:absolute;top:50%;right:11px;color:var(--accent);font:700 var(--text-sm) var(--mono);transform:translateY(-55%)}.mobile-stage-guidance[open] summary::after{transform:translateY(-45%) rotate(180deg)}.mobile-stage-guidance-headings{display:grid;grid-template-columns:var(--guidance-label-column) minmax(0,1fr);align-items:center;gap:10px}.mobile-stage-guidance-headings strong{font:700 var(--text-xs) var(--mono)}.mobile-stage-guidance-headings span{color:var(--muted);font-size:var(--text-2xs)}.mobile-stage-guidance>div{display:grid;grid-template-columns:var(--guidance-label-column) minmax(0,1fr);gap:10px;padding:9px 11px;border-top:1px solid var(--border)}.mobile-stage-guidance>div>strong{color:var(--accent);font:700 var(--text-2xs) var(--mono);letter-spacing:.06em;text-transform:uppercase}.mobile-stage-guidance p{margin:0;color:var(--muted);font-size:var(--text-xs);line-height:1.45}
