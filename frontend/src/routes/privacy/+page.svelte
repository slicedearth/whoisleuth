...
<article class="policy card">
  ...
  <p><strong>Deep lookup evidence.</strong> A requested deep lookup can display bounded HTTP metadata and static page-identity fields derived from the homepage response already fetched for analysis. Page identity can include language, canonical and meta-refresh targets, selected Open Graph fields, generator metadata, forms, normalized resource counts, external resource and embedded origins, mail-contact domains, download context, and recognized public tracking identifiers. URL credentials, queries, fragments, resource and download paths, form-action paths, and complete email addresses are not retained. This richer evidence is not copied into Bulk, watchlists, or analyst cases.</p>
