// Browser-safe collection bounds shared by the network evidence producers,
...
export const MAX_LOOKUP_TLS_FINDINGS = 5;
export const MAX_LOOKUP_TLS_CERTIFICATE_POLICIES = 16;
